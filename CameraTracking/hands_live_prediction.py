...
model = load_model('presentation_model.h5')
params = Params()
...
with handsModule.Hands(model_complexity=0,static_image_mode=False, min_detection_confidence=0.7, min_tracking_confidence=0.7,
